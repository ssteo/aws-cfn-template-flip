...
def main():
    ...
    parser.add_argument("-v", "--validate", action="store_true", help="Validates your template against the latest CloudFormation specification.")
    ...
    try:
        args.output.write(flip(template, args.clean, args.validate))
